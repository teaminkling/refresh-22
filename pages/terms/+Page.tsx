...
import {
  ...
  SubHeader,
  UnorderedList,
} from "../../components/markup/typography.tsx";
  ...
  return (
    <>
      ...
      <StaticPage>
        ...
        <Paragraph>
          Aside from following laws in international/Australian jurisdictions, we make specific attempts to abide by
          local laws in North America and the European Union.
        </Paragraph>

        <SubHeader>Foreword</SubHeader>

        <Paragraph>
          By accessing this website and using any of our products and services, you agree to be bound by our Terms of
          Use, all applicable laws and regulations, and agree that you are responsible for compliance with any
          applicable local laws of which we may not be aware.
        </Paragraph>

        <Paragraph>
          The materials contained in this website and other products and services are protected by any applicable
        ...
        <Paragraph>
          Permission is granted to temporarily download content on this website for personal non-commercial transitory
          viewing only. This is a grant of a license, not a transfer of title, and under this license you may:
        </Paragraph>

        <UnorderedList>
          <ListItem>
            Not copy/modify the materials publicly. You may copy/modify assets (e.g., marketing art assets), but you
          ...
          <ListItem>
            Not &quot;permalink&quot; to static web content including (but not limited to) images, audio files, and
            videos.
          </ListItem>
        </UnorderedList>
        ...
        <Paragraph>
          Permalinking is the act of directly linking to image, video, audio files (not the URL including the title,
          author, and description), or other media on social media or any other website and it is strictly disallowed
          here.
        </Paragraph>
        ...
        <Paragraph>
          Again, to be clear: if it does not end in a file extension like <code>.png</code>, <code>.mp3</code> etc.,
          then it is <b>okay to link</b>.
        </Paragraph>
        ...
        <Paragraph>
          ...
          copyright holders and hosted on this web site.
        </Paragraph>

        <Paragraph>
          Due diligence has been exercised to ensure sufficient attribution and permission to use and showcase IP.
          Posting works to the site via the upload form, for instance, is used as implicit permission to post work on
          this website. However, full rights remain to the original IP holder: we just hold the rights to host it to be
          displayed in our application and on our servers.
        </Paragraph>
        ...
        <Paragraph>
          These terms and conditions, challenge rules, or Privacy Policy may change at any time without notice. Users of
          the site agree to these conditions immediately on change even if they are not made aware of the changes.
        </Paragraph>
